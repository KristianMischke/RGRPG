...
public class DiscordRpc
{
    ...
    const string discordDLL = "discord-rpc";
#else
    const string discordDLL = "libdiscord-rpc";
#endif
    ...
    [DllImport(discordDLL, EntryPoint = "Discord_UpdateHandlers", CallingConvention = CallingConvention.Cdecl)]
